...
export default ({ tokens, open, onClose }: RecoveryTokenDialogProps) => {
    ...
    return (
        <Dialog
            ...
            description={
                'Сохраните приведенные ниже коды в безопасном месте. Если вы потеряете доступ к своему телефону, вы сможете использовать эти резервные коды для входа в систему.'
            }
            hideCloseIcon
