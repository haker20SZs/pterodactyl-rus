        ...
        <form id={'disable-totp-form'} className={'mt-6'} onSubmit={submit}>
            ...
            <Dialog.Footer>
                ...
                <Tooltip
                    ...
                    content={'Для продолжения необходимо ввести пароль учетной записи.'}
                >
...
export default asDialog({
    title: 'Отключить двухэтапную верификацию',
    description: 'Отключение двухэтапной проверки сделает вашу учетную запись менее безопасной.',
})(DisableTOTPDialog);
