    ...
    return (
        <form id={'enable-totp-form'} onSubmit={submit}>
            ...
            <p id={'totp-code-description'} className={'mt-6'}>
                Отсканируйте приведенный выше QR-код с помощью выбранного вами приложения для двухэтапной аутентификации. Затем введите 6-значный
                сгенерированный код в поле ниже.
            </p>
            <Input.Text
                ...
                <Tooltip
                    ...
                    content={
                        !token
                            ...
                            : 'Для продолжения необходимо ввести 6-значный код и пароль.'
                    }
                    delay={100}
                >
                    <Button
...
export default asDialog({
    title: 'Включить двухэтапную верификацию',
    description:
        "Поможет защитить вашу учетную запись от несанкционированного доступа. При каждом входе в систему вам будет предложено ввести проверочный код.",
