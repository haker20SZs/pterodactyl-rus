...
<div class="row">
    <div class="col-xs-12">
        <div class="alert alert-danger">
            Ядра — это мощная функция Pterodactyl Panel, обеспечивающая исключительную гибкость и настройку. Обратите внимание, что, несмотря на свою эффективность, неправильное изменение ядра может очень легко вывести из строя ваши сервера и вызвать больше проблем. Пожалуйста, не редактируйте ядра по умолчанию — те, которые предоставлены <code>support@pterodactyl.io</code> — если Вы абсолютно не уверены в том, что делаете.
        </div>
    </div>
</div>
<div class="row">
