...
<div class="row">
        ...
        <div class="row">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tr>
                                <td>Версия Демона</td>
                                <td><code data-attr="info-version"><i class="fa fa-refresh fa-fw fa-spin"></i></code> (Последяя: <code>{{ $version->getDaemon() }}</code>)</td>
                            </tr>
                            <tr>
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">Удаление узла является необратимым действием и приведет к немедленному удалению этого узла с панели. Чтобы продолжить, с этим узлом не должно быть связано ни одного сервера.</p>
                    </div>
    ...
    <div class="col-sm-4">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Быстрый Обзор</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-orange">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                <span class="info-box-text">Этот узел находится под</span>
                                <span class="info-box-number">Обслуживанием</span>
                            </div>
                        </div>
                    </div>
                    @endif
