...
@section('title')
    Подключение &rarr; Просмотр &rarr; {{ $mount->id }}
@endsection
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.mounts') }}">Подключение</a></li>
...
@section('content')
    <div class="row">
        <div class="col-sm-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Детали подключения</h3>
                </div>
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Ядра</h3>

                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addEggsModal">Добавить Ядро</button>
                    </div>
                </div>
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addNodesModal">Добавить Узел</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.eggs', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Добавить Ядро</h4>
                    </div>

                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="pEggs">Ядра</label>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.nodes', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Добавить Узел</h4>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('button[data-action="detach-egg"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    swal({ type: 'success', title: 'Ядро удалено.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'УПС!',
            ...
            $('button[data-action="detach-node"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    element.parent().parent().addClass('warning').delay(100).fadeOut();
                    swal({ type: 'success', title: 'Узел удалён.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'УПС!',
